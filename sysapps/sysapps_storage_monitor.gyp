  ...
  'targets': [
    {
      ...
      'target_name': 'chrome_storage_monitor',
      'type': 'static_library',
      'includes' : [
      ...
      'sources': [
        ...
        '../../chrome/browser/storage_monitor/mock_removable_storage_observer.cc',
        '../../chrome/browser/storage_monitor/mock_removable_storage_observer.h',
